...
public class BattleLoc extends Location{
                ...
                if (selectCombat.equals("V")) {
                    if (firstHit == 0) {            // Yüzde 50 ihtimal var. eğer 0 ise player,1 ise canavar vuracak.
                        ...
                        if (this.getObstacle().getHealth() > 0) {
                            int durability = this.getObstacle().getDamage() - this.getPlayer().getInventory().getArmor().getAvoid();
    ...
    public void playerStats() {
        ...
        System.out.println("Bloklama : " + this.getPlayer().getInventory().getArmor().getAvoid());
