...
public class OperatorGUI extends JFrame {
    ...
    private JTextField fld_sc_user_uname;
    private JComboBox cmb_ch_user_type;
    ...
    public OperatorGUI(Operator operator){
        ...
        tbl_user_list.getModel().addTableModelListener(e -> {
            if (e.getType() == TableModelEvent.UPDATE){
                ...
                String user_uaname = tbl_user_list.getValueAt(tbl_user_list.getSelectedRow(),2).toString();
                String user_pass = tbl_user_list.getValueAt(tbl_user_list.getSelectedRow(),3).toString();
                String user_type = tbl_user_list.getValueAt(tbl_user_list.getSelectedRow(),4).toString();

                if (User.update(user_id,user_name,user_uaname,user_pass,user_type)){
        ...
        updateMenu.addActionListener(e -> {
            ...
            UpdatePatikaGUI updatePatikaGUI = new UpdatePatikaGUI(Patika.getFach(select_id));
        ...
        btn_user_sh.addActionListener(e -> {
            ...
            String uname = fld_sh_user_name.getText();
            String type = cmb_ch_user_type.getSelectedItem().toString();
